...
public class ColumnsRecord extends org.jooq.impl.TableRecordImpl<nu.studer.sample.information_schema.tables.records.ColumnsRecord> {

	private static final long serialVersionUID = 1105205053;
	...
	public ColumnsRecord() {
		super(nu.studer.sample.information_schema.tables.Columns.COLUMNS);
	}
